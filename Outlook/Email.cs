    ...
    public class Email
    {
        ...
        /*        public static bool sendEmailViaOutlook(string sFromAddress, string sToAddress, string sCc, string sSubject, string sBody, BodyType bodyType, List<string> arrAttachments = null, string sBcc = null)
        {
            ...
            try
            {
                ...
                Outlooks.Application app = new Outlooks.Application();
                Outlooks.MailItem newMail = (Outlooks.MailItem)app.CreateItem(Outlooks.OlItemType.olMailItem);
                ...
                Outlooks.Accounts accounts = app.Session.Accounts;
                Outlooks.Account acc = null;

                //Look for our account in the Outlook
                foreach (Outlooks.Account account in accounts)
                {
                ...
                if (acc != null)
                {
                    ...
                    //And send it
                    ((Outlooks._MailItem)newMail).Send();
